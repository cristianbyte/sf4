...
import { userSchema, guestSchema, loginSchema, uuidSchema, locationWithUuidSchema } from '../schemas/user.js'
...
user.post('/guest', validateSchema({body: guestSchema}), createUser) 
//LogOut
