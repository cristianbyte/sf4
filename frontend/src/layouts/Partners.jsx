...
import Nectar from '../assets/partners/Nectar-min.png'
import './partners.css'
        ...
        <div className="partners">
            <div className="partners-container">
                ...
                <div className="partners-section">
                    ...
                    <div className="partners-logo">
                        <a className='partners-pic' href="https://www.instagram.com/aguardientenectar_oficial/" target="_blank" rel="noopener">
                            <img src={Nectar} alt="aguardiente nectar" />
                        </a>
                    ...
                    <div className="footer-content">
                        ...
                        <div className="footer-main">
                            ...
                            <div className="footer-social">
                                ...
                                <a
                                    href="https://www.instagram.com/cristianbyte"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="social-link"
                                >
